 ...
 */
class StartarbihunterCommand extends UserCommand
{
    protected $name = 'startarbihunter';
    protected $description = 'Start command';
    protected $usage = '/startArbiHunter';
    ...
    public function execute(): ServerResponse
    {
        ...
        $textDB = DatabaseService::getMessage('welcome_text_ArbiHunter');
        $text = <<<TEXT
        Hey there!
